import { ENCRYPTION_KEY_PREFIX } from '@/config';
 ...
 */
export const clearStoredSession = async (userAddress: Address) => {
  console.log('Clearing session for address:', userAddress);
  localStorage.removeItem(await getStorageKey(userAddress));
